...
from src.plotting import convert_and_plot
import os

# Directory where your dataframes are stored
input_dfs = "FVA_1"
...
# Uptake originally had negative value, an Na indicates that the model cannot handle the molecule (hence equivalent to 0)
...
jakobs_list = ["d-arabinose","d-galacturonate","d-xylose","fructose","g-amino-butyric_acid","glutamate","glycerol","lactate","lactose","melibiose","sucrose","trehalose","alanine","l-arabinose","l-rhamnose","acetate","maltose","aspartate","glycine","histidine","l-arginine","leucine","mannose","serine","galactose","l-fucose","ribose"]
...
performance_metrics = "Precision: " + str(precision) + "\n" + "Recall: " + str(recall) + "\n" + "F1 Score: " + str(f1_score) + "\n" + "Accuracy: " + str(accuracy) + "\n" + "Specificity: " + str(specificity)
...
performance_metrics_jakobs_list = "Precision: " + str(precision) + "\n" + "Recall: " + str(recall) + "\n" + "F1 Score: " + str(f1_score) + "\n" + "Accuracy: " + str(accuracy) + "\n" + "Specificity: " + str(specificity)
...
print(performance_metrics_jakobs_list+"\n")
print("\nThe plots have been saved under the 'Results' folder\n")
